    ...
    return (
        <nav className={navbar ?  "navActiveLight": "nav"} >
          ...
          {/* <RightContainer> */}
            ...
            <PC>
              <ul className="list">
                  <Hr href="http://donor-vaults.s3-website-us-west-2.amazonaws.com/#/avax" spy={true} smooth={true} offset={-80}>Asset Structuring</Hr>
                  {/* <Link2 to="/earn" spy={true} smooth={true} offset={-80}>Earn</Link2>
                  <Link2 to="/donate" spy={true} smooth={true} offset={-80}>Donate</Link2> */ }
                  <Link2 to="/donate" spy={true} smooth={true} offset={-80}>Transfer Agent</Link2>  
                  <Link2 to="/docs" spy={true} smooth={true} offset={-80}>Real Estate Tokenization</Link2>
                  <Link2 to="/work" spy={true} smooth={true} offset={-80}>HNI’s & Family Offices</Link2> 
              </ul> 
            </PC>
